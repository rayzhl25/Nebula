          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden min-h-[500px]">
            ...
            <div className="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
               ...
               {filteredProjects.map(project => (
                 <div key={project.id} className="group p-5 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-nebula-500 dark:hover:border-nebula-500 hover:shadow-md transition-all cursor-pointer bg-gray-50 dark:bg-gray-800/50 relative">
